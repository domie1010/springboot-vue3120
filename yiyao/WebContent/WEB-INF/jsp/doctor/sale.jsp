...
<html>
	...
	<body>
	    ...
	    <form method="post" action="${basePath }sys/inventory/sale" id="medicineForm">
		    <div class="formbody">
			    ...
			    <ul class="forminfo">
				    ...
				    <li><label>&nbsp;</label><input id="addBtn" type="button" class="btn" value="销售"/><i><font><b>${addMessage }</b></font></i></li>
			    </ul>
		    </div>
	    </form>
